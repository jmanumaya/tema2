...
public class Ejer1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Dime el número de asteriscos que tiene que tener por cada lado: ");
		lados = sc.nextInt();
		
		// For para las veces que se va a repetir segun las lineas que necesite.
		for (int i = 1; i <= lados; i++) {
			
			// If para imprimir los asteriscos si nos encontramos en la primera o ultima fila.
			if (i == 1 || i == lados) {
				
				// For para hacer ese bucle de veces que se tiene que pintar el asterisco cuando se cumpla la condición del if
